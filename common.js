...
function writeWinner() {
    ...
    if(winCount > eWinCount) {
        document.getElementById("mWin").innerHTML = "Victory";
        document.getElementById("eWin").innerHTML = "Defeat";
    }
    else if(winCount < eWinCount){
        document.getElementById("eWin").innerHTML = "Victory";
        document.getElementById("mWin").innerHTML = "Defeat";
    }
        ...
        if(score > eneScore) {
            ...
            document.getElementById("mWin").innerHTML = "Tie";
            document.getElementById("eWin").innerHTML = "Tie";
        }
    }
}
...
document.getElementById("men").addEventListener('click', function () {
    ...
    if (!isThisCellFull(idList[n]) && isTotalLessThanThree()) {
        document.getElementById(idList[n]).innerHTML += 'M';
...
document.getElementById("ko").addEventListener('click', function () {
    "use strict";
    if (!isThisCellFull(idList[n]) && isTotalLessThanThree()) {
        document.getElementById(idList[n]).innerHTML += 'K';
        addedScoreList.push(idList[n]);
        upDateScore();
    } else {alert("Click Next Button"); }
}, false);

document.getElementById("do").addEventListener('click', function () {
    "use strict";
    if (!isThisCellFull(idList[n]) && isTotalLessThanThree()) {
        document.getElementById(idList[n]).innerHTML += 'D';
        addedScoreList.push(idList[n]);
        upDateScore();
    } else {alert("Click Next Button"); }
}, false);
...
document.getElementById("tu").addEventListener('click', function () {
    "use strict";
    if (!isThisCellFull(idList[n]) && isTotalLessThanThree()) {
        document.getElementById(idList[n]).innerHTML += 'T';
        addedScoreList.push(idList[n]);
        upDateScore();
    } else {alert("Click Next Button"); }
}, false);
...
//console.log("TEMP" + temp.slice(0, i) + temp.slice(i));
                document.getElementById(idList[n]).innerHTML += 'H';
                FoundH = true;
            }
        }
...
document.getElementById("Enemen").addEventListener('click', function () {
    ...
    if (!isThisCellFull(EneidList[n]) && isTotalLessThanThree()) {
        document.getElementById(EneidList[n]).innerHTML += 'M';
...
document.getElementById("Eneko").addEventListener('click', function () {
    "use strict";
    if (!isThisCellFull(idList[n]) && isTotalLessThanThree()) {
        document.getElementById(EneidList[n]).innerHTML += 'K';
        addedScoreList.push(EneidList[n])
        upDateScore();
    } else {alert("Click Next Button"); }
}, false);
...
document.getElementById("Enedo").addEventListener('click', function () {
    "use strict";
    if (!isThisCellFull(idList[n]) && isTotalLessThanThree()) {
        document.getElementById(EneidList[n]).innerHTML += 'D';
        addedScoreList.push(EneidList[n])
        upDateScore();
    } else {alert("Click Next Button"); }
}, false);
...
document.getElementById("Enetu").addEventListener('click', function () {
    "use strict";
    if (!isThisCellFull(idList[n]) && isTotalLessThanThree()) {
        document.getElementById(EneidList[n]).innerHTML += 'T';
        addedScoreList.push(EneidList[n])
        upDateScore();
    } else {alert("Click Next Button"); }
}, false);
...
//console.log("TEMP" + temp.slice(0, i) + temp.slice(i));
                document.getElementById(EneidList[n]).innerHTML += 'H';
                FoundH = true;
            }
        }
...
document.getElementById('next').addEventListener('click', function () {
    ...
    if(n < 4 && n > -1){ // means n is btw 0 to 3(one before last)
      ...
      upDateScore();
      writeWinner();
      alert("Good Work! Match Finished");
    }
